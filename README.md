...
Dashboard Tasarımı:
Dashboard’un arka plan tasarımı ve genel yerleşim planı, Power BI’a aktarılmadan önce Microsoft PowerPoint kullanılarak özel olarak hazırlanmıştır.

Bu yöntem sayesinde:

Tutarlı renk paleti oluşturulmuş

Sol panel tasarımı yapılandırılmış

Görsel hiyerarşi güçlendirilmiş

Daha profesyonel bir sunum görünümü elde edilmiştir

Ardından Power BI içerisinde görseller hizalanarak ve optimize edilerek kullanıcı dostu ve temiz bir tasarım oluşturulmuştur.
...
If necessary, reconnect the dataset.

Enable Map visuals from:
